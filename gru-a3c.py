...
def attention_heatmap(alpha):
    ...
    upsampled_heatmap = skimage.transform.pyramid_expand(heatmap, upscale = 16 , sigma=20)
...
def test(save_dir):
    ...
    while not done:
        ...
        #if i%20==0:
            #plt.show()
        #cv2.imshow('heatmap', ((heatmap).astype('float32')))
        #time.sleep(1)
...
if __name__ == "__main__":
    ...
    if args.test:
        args.save_dir = 'breakoutdeterministic-v4_gru/'
        test(args.save_dir)
    else:
